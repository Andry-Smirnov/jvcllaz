...
type
  ...
  private
    ...
    procedure DoLMouseBtnDown(Sender: TObject; Button: TMouseButton;
      Shift: TShiftState; {%H-}X, {%H-}Y: Integer);
    procedure DoMouseBtnUp(Sender: TObject; {%H-}Button: TMouseButton;
      {%H-}Shift: TShiftState; {%H-}X, {%H-}Y: Integer);
    procedure DoRMouseBtnDown(Sender: TObject; Button: TMouseButton;
      Shift: TShiftState; {%H-}X, {%H-}Y: Integer);
...
begin
  ...
  begin
    ...
    OnMouseDown := @DoLMouseBtnDown;
    OnMouseUp := @DoMouseBtnUp;
    //    OnClick := LeftClick;
  end;
...
procedure TJvCustomTMTimeline.DoLMouseBtnDown(Sender: TObject; Button: TMouseButton;
...
procedure TJvCustomTMTimeline.DoRMouseBtnDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  if Button = mbRight then
    Exit;
...
procedure TJvCustomTMTimeline.DoMouseBtnUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  FBtnDown := bdNone;
  StopTimer;
