...
Portions created by Peter Thцrnqvist are Copyright (C) 1996 Certified Software Corp.
All Rights Reserved.

Contributor(s): Peter Thцrnqvist [peter3 at sourceforge dot net]
...
const
  EmptyLine = '0.00';
  DefHeader2 =
    'Profiler 32 - (C) 1996 Certified Software Corp, portions Copyright (C) 1997 by Peter Thцrnqvist; all rights reserved.';
